			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					@endif
						...
						{!! Form::model($eventoAcademico, ['route' => ['eventoAcademico.update', $eventoAcademico], 'method' => 'PUT']) !!}
					...
					<div class="form-group" style="display: none">
						...
						<div class="form-group">
							{!! Form::label('fecha_fin', 'Fecha Finalización') !!}
							<input type="date" class="form-control" name="fecha_fin" id="campoF">
						</div>
						<div class="form-group">
