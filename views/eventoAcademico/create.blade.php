						...
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ url('/eventoAcademico') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" id="titulo"name="titulo" id="titulo" value="{{ old('titulo') }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="url" class="form-control" name="enlace" id="enlace" value="{{ old('enlace') }}">
                                    </div>
                                </div>
