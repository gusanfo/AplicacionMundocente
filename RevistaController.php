...
class RevistaController extends Controller {
	...
	public function index(Request $request)
	{
		if(self::tipo_usuario()=="Publicar"){
			...
			if($request->get('areas') != '' || $request->get('universidad') != ''){	
				 			 //:::::::. Filtro Avanzado ::::::::::.
				$revistas  = Revista::filterAdvanced($request->get('areas'),$request->get('universidad'));
			}
		}
...
/**
	...
	public function edit($id)
	{
		...
		$areas = Area::all();
		$areas2 = \DB::table('areas')->where('tipo',null)->get();
		return view('revistas.edit',compact('revista','areas','areas2'));
	}
